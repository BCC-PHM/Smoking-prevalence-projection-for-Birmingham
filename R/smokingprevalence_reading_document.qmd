...
In each cycle, individuals can die from any states. The all-cause mortality rates were derived from the national life tables 2021-2023 [@ONS_2024_national_life_tables] and subsequently averaged across the three smoking status groups: non-smokers, current smokers, and ex-smokers. This analysis uses the equation from a prior study to calculate the death risk for non-smoker [@Song380], as shown below:
...
Figure 1 shows that at the beginning of each year t, the population is divided into three main states: non-smokers, current smokers, and ex-smokers.

-   **Non-smokers:** At year *t+1*, the number of non-smokers equals to (1) the number of people who were non-smokers in year *t* and remained non-smokers, plus (2) the number of ex-smokers who reached 10 years since quitting in year *t* and transitioned back to the non-smoker state, minus (3) the number of non-smokers in year *t* who started smoking and moved to the smoker state in year *t+1*, minus (4) the number of non-smokers in year *t* who died, plus (5) the net number of non-smokers migrating into Birmingham (in-migrants minus out-migrants) during year *t*.

-   **Current smokers:** At year *t*+1, the number of current smokers equals (1) those who were smokers in year t and continued smoking, plus (2) non-smokers in year t who started smoking in year *t*+1, plus (3) ex-smokers in year *t* who relapsed and returned to smoking, minus (4) smokers in year *t* who quit and moved to the ex-smoker state, minus (5) smokers in year *t* who died, plus (6) the net number of smokers migrating into Birmingham during year *t*.

-   **Ex-smokers:** At year *t*+1, the number of ex-smokers equals (1) those who were ex-smokers in year *t* and remained ex-smokers, plus (2) smokers in year *t* who quit during the year and became new ex-smokers, plus (3) every former smoker who quit between year *t–10* and *t* and continues to remain smoke-free (i.e., those progressing through the “time since quit” categories up to 10 years), minus (4) ex-smokers in any “time since quit” category who relapsed and returned to smoking, minus (5) ex-smokers in any “time since quit” category who died during year *t*, minus (6) ex-smokers in year *t* who reached 10 years since quitting and transitioned back to the non-smoker state, plus (7) the net number of ex-smokers migrating into the area during year *t*.

At the end of each cycle, every person ages by one year (i.e., age *a* becomes *a+1* in year *t+1*), and in each new year *t+1*, a new cohort of 13-year-olds enters the model as non-smokers. Every person is given a new set of age and gender specific transition probabilities when cycle moves forward. For example, a 17-year-old male in year t will be assigned the transition probabilities corresponding to 17-year-old males; when he becomes 18 in the next cycle (*t*+1), his probabilities are updated to those specific to 18-year-old males. This ensures that changes in smoking behaviour reflect age- and gender-related differences in initiation, quitting, relapse, and mortality rates over time.

### How scenario works?

To model each policy scenario, assumptions of reduction in instigation rate were applied at 10%, 30%, 60% and 90%. It has to be noted that the reduction in instigation is year-by-year, meaning that reduction will get compounded over time, implying that the implementation of the policy does not provide a one-off change but the effect becomes progressively more effective. For example, under a 10% annual reduction scenario, the instigation rate in year *t* would be multiplied by 0.9. In the following year (*t+1*), the rate would be further multiplied by 0.9², and so on, leading to a cumulative reduction effect over time.
...
Therefore, this analysis introduces the Tobacco and Vapes Bill within the 2027 model cycle, assuming that individuals turning 18 in 2027 will be the first cohort affected by the policy. The model applies a year-on-year reduction in instigation rates, meaning the effect compounds over time as younger cohorts progressively enter the population under the new legislation. However, as there is currently no empirical evidence quantifying the potential impact of the Bill, the effect must be modelled through assumptions. Accordingly, Scenarios 1–4 represent varying levels of reduction in smoking instigation rates, modelled as 10%, 30%, 60%, and 90% decreases, respectively, relative to the baseline scenario of no policy intervention.

The results show that for those among 14 to 30 years old, smoking prevalence is projected to decline to 4.13% by 2047 under Scenario 1 (10% reduction in instigation rate), while Scenario 2 (30% reduction) reaches 2.1% in the same year. Scenarios 3 and 4, representing larger reductions of 60% and 90%, produced almost identical trends, with prevalence stabilising at 1.97% by 2047.
...
The results show that for adults (18+), smoking prevalence is projected to decline to 3.98% by 2047 under Scenario 1 (10% reduction in instigation rate), while Scenario 2 (30% reduction) reaches 2.97% in the same year. Scenarios 3 and 4, representing larger reductions of 60% and 90%, produced almost identical trends, with prevalence stabilising at approximately 2.7% by 2047.
