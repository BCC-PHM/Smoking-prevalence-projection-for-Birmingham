...
In each cycle, individuals can die from any states. The all-cause mortality rates were derived from the national life tables 2021-2023 [@ONS_2024_national_life_tables] and subsequently averaged across the three smoking status groups: non-smokers, current smokers, and ex-smokers. uses the equation from a prior study to calculate the death risk for non-smoker, as shown below:
